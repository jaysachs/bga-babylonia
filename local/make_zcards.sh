...
do
    CMD+=" \( canvas:none -stroke black -fill \#D6C6B5 -draw 'rectangle 0,0,183,227' -fill \#924018 -draw 'polygon ${ZIG}' -stroke black -strokewidth 2 -fill black -gravity center -pointsize 42 -draw 'text 0,0 \""${C}"\"' -gravity SouthWest -pointsize 24 -strokewidth 1 -draw 'text 8,5 \""$((NUM++))"\"' \) "
