...
COLORS=("${(@f)$(strip-json-comments ../gameinfos.jsonc | jq '.["player_colors"].[]')}" 79e8f3)
...
do
    ...
    magick -size ${SIZE} -gravity center canvas:none -stroke black -fill \#${C} -draw 'circle 100,86 100,168' +append P-${I}-hand.png
